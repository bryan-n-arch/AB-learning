...
def CollateMetadataAndPhenotypes(z_root_genespace, df_metadata_2017, df_metadata_2022, df_phenotypes_2017, df_phenotypes_2022):
	...
	# 2.) Prep metadata, need both 2017 and 2022 together to perform accurate filtering
...
def DeriveAccessionColorScheme(num_accessions, species_vector, serotype_vector):
	...
	# a.) Species
	for i, (value, count) in enumerate( Counter( species_vector ).most_common(21) ):
	...
	for i, (value, count) in enumerate( Counter( serotype_vector ).most_common(21) ):
